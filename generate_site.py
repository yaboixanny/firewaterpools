        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <p class="text-slate-400 mb-8 leading-relaxed">Premier pool service and maintenance for Vero Beach and Indian River County. Locally owned and operated.</p>
...
def main():
    ...
    for s in service_pages:
        ...
        <div class="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all hover:-translate-y-1 group border border-slate-100 flex flex-col h-full">
            ...
            <p class="text-slate-600 leading-relaxed flex-grow">{s['metaDescription']}</p>
        </div>
        """
